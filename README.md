...
- `apps.json` — machine-readable catalog of the curated apps (devId 8108071590254123611)
- Apps link straight to Play Store, builds link to GitHub
- Zero-build static site, light minimal UI, fully responsive + JSON-LD Person schema
